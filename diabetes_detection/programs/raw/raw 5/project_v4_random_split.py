...
all_data = raw_dataset.drop(['Outcome'], axis = 1) # droping 'Outcome' from train
####################################################################################################
#                                   data checking
####################################################################################################
# hit_map : 1
...
####################################################################################################
all_data['Id'] = dataset_ID
if controler.save_all_data  or controler.all:
    all_data.to_csv(path+'Final_dataset project_v4_random_split.csv.csv')
    print('\nAll final data has been saved at : '+path+'Final_dataset project_v4_random_split.csv\n')
